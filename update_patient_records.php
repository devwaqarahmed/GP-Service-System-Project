<?php
   ...
   error_reporting(0);
       ...
       if(isset($_POST['update_patient'])){
                   ...
                   $current_patient_id=$_GET['p_id'];
                   
                 
   
                   // update the data into the database
                
                   $sql = "UPDATE `patients` SET `nhs_number`='$nhs_number',`first_name`='$first_name',`last_name`='$last_name',`password`='$password' WHERE id='$current_patient_id'";
   ...
   <body>
      ...
      <main id="main">
         ...
         <section id="services" class="services">
            ...
            <h2 class="fw-bold mb-2 text-uppercase">Update Patient Records</h2>
            </div>

            <form action="" method="POST">
               <div class="card-body px-4">
               <label for="nhs_number">NHS Number:</label>
               <input type="text" name="nhs_number" class="form-control">
               </div>
               ...
               <input type="hidden" name="current_patient_id" value="<?php $current_patient_id ?>">

               <div class="card-body px-4 text-center">
               <input type="submit" class="btn btn-outline-warning btn-lg px-5 text-body-center mt-3" value="Update" name="update_patient">
               </div>
            </form>
            </div>
            </div>
