<?php
   ...
   if($nhs_number!=="" && $first_name!=="" && $last_name!=="" && $date!=="" && $password!==""){
   $sql = "INSERT INTO patients (nhs_number, first_name, last_name, password, register_date)
   VALUES ('$nhs_number', '$first_name', '$last_name', '$password','$date')";
      ...
      <main id="main">
         ...
         <section id="services" class="services">
            ...
            <form action="" method="POST">
               ...
               <div class="card-body p-4 text-center">
               <input type="submit" class="btn btn-outline-warning btn-lg px-5 text-body-center" value="Sign Up" name="register">
               </div>
