<?php
   ...
   $fetch_query = "SELECT * FROM `patients` WHERE `first_name` = '$username' ";
   ...
   <body>
      ...
      <main id="main">
         ...
         <section id="services" class="services">
            ...
            <div class="card-body px-1 text-center mt-4">
            ...
            <form action="" method="POST">
              ...
              <div class="card-body  text-center">
                  <p>Don't have an account? <a href="register_patient.php" class="text-white-50 fw-bold">Sign Up</a>
                  </p>
              </div>
      ...
      <!-- Vendor JS Files -->
      <script src="other_assets/vendor/purecounter/purecounter_vanilla.js"></script>
      <script src="other_assets/vendor/aos/aos.js"></script>
      <script src="other_assets/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
      <script src="other_assets/vendor/glightbox/js/glightbox.min.js"></script>
      <script src="other_assets/vendor/isotope-layout/isotope.pkgd.min.js"></script>
      <script src="other_assets/vendor/swiper/swiper-bundle.min.js"></script>
      <script src="other_assets/vendor/php-email-form/validate.js"></script>
      <!-- Main JS File -->
      <script src="other_assets/js/main.js"></script>
   </body>
</html>
