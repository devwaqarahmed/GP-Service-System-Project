<?php
   ...
   error_reporting(0);
        ...
        $sql = "INSERT INTO `patient_records`( `patient_id`, `record_type`, `date`, `description`) VALUES ('$patient_id','$record_type','$date','$descripition')";
        
        if ($conn->query($sql) === TRUE) {
           
      echo "<script>alert('Patient Record Added')</script>";
      ...
      <main id="main">
         ...
         <section id="services" class="services">
            ...
            <form action="" method="POST">
               ...
               <input type="text" name="record_type" class="form-control" required>
               </div>
               ...
               <input type="submit" class="btn btn-outline-warning btn-lg px-5 text-body-center mt-3" value="Add record" name="add">
               </div>
            </form>
            </div>
            </div>
