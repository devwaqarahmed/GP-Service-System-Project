<?php
   ...
   $fetch_query = "SELECT * FROM `doctors` WHERE `first_name` = '$username' ";
   ...
   <body>
      ...
      <main id="main">
         ...
         <section id="services" class="services">
            ...
            <div class="card-body px-3 text-center mt-4">
            ...
            <form action="" method="POST">
              ...
              <p><a class="text-white-50" href="#!">Forgot password?</a></p>
               ...
               <div class="card-body  text-center">
                  <p>Don't have an account? <a href="register_doctor.php" class="text-white-50 fw-bold">Sign Up</a>
                  </p>
               </div>
